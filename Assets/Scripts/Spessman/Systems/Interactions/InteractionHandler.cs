...
namespace Spessman.Interactions
{
    ...
    public class InteractionHandler : NetworkBehaviour
    {
        ...
        public void InteractInHand(GameObject target, GameObject sourceObject, bool showMenu = false)
        {
            ...
            InteractionEvent interactionEvent = new InteractionEvent(owner, source, null);
        ...
        private List<InteractionEntry> GetViableInteractions(Ray ray, out InteractionEvent interactionEvent)
        {
            ...
            interactionEvent = new InteractionEvent(owner, source, targets[0], point);
            ...
            List<IInteractionTarget> targets, InteractionEvent @event)
        {
            ...
            List<InteractionEntry> interactions = targets.SelectMany(t => 
                t.GenerateInteractions(new InteractionEvent(owner, source, t, @event.Point))
            ...
            return interactions.Where(i => i.Interaction.CanInteract(new InteractionEvent(owner, source, i.Target, @event.Point))).ToList();
        }
