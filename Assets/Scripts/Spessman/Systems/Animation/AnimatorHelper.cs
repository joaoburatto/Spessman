...
<<<<<<< Updated upstream:Assets/Scripts/AnimatorHelper.cs
public class AnimatorHelper : MonoBehaviour
{
    public Animator animator;
=======
namespace Spessman.Systems.Animation
{
    /// <summary>
    /// This helps the animations go brrr
    ///
    /// works like shite
    /// </summary>
...
>>>>>>> Stashed changes:Assets/Scripts/Spessman/Systems/Animation/AnimatorHelper.cs
    ...
    private void UpdateHandsAnimation()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            // if there's a null clip we set it to empty
